...
class Server(LimitTotalConnectionsFactory):
    ...
    def refresh(self):
        ...
        self.incMessages(len(self.players), 0)
    ...
    def controlGamesPlayed(self):
        return self.gamesPlayed

    def controlMessagesSent(self):
        return self.messages[0]

    def controlMessagesReceived(self):
        return self.messages[1]

    def incMessages(self, sent, received):
        self.messages[0] += sent
        self.messages[1] += received
